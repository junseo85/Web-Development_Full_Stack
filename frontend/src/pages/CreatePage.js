...
export const CreatePage =() => {
    const [title, setTitle] = useState('award');
    const [date, setDate] = useState();
    const [name, setName] = useState('name');
    const [placement, setPlacement] = useState('1st prize winner');
            ...
            <tbody>
                <tr>
                    ...
                    <td><label for="placement" >
                        ...
                        <td><label for="submit"><button class="submit" onClick={addAward} id="submit">Save</button></label></td>
                </tr>
            </tbody>
        </table>
        </article>
